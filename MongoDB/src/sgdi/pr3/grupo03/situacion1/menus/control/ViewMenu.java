...
import sgdi.pr3.grupo03.situacion1.menus.episode.ShowEpisodeRatings;
import sgdi.pr3.grupo03.situacion1.menus.film.ShowFilmRatings;
import sgdi.pr3.grupo03.situacion1.menus.season.ShowSeasonRatings;
import sgdi.pr3.grupo03.situacion1.menus.series.ShowSeriesRatings;
...
public class ViewMenu extends Menu<Integer> {
	...
	public void input(Integer option) {
		...
		case 3:
			...
			break;
		case 4:
			ConsoleUtil.drawMenu("Elige un tipo", RETURN_INT, EditMenu.TYPES);
