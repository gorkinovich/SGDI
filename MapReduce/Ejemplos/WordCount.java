...
public class WordCount {
    /**
     * <p>El mapper extiende de la interfaz org.apache.hadoop.mapreduce.Mapper.
     * Cuando se ejecuta Hadoop el mapper recibe cada linea del archivo de entrada
     * como argumento. La función "map" parte cada línea y para cada palabra emite
     * la pareja (word,1) como salida.</p>
     */
     ...
     * total de apariciones.</p>
     * <p>Ojo: como las parejas generadas por la función "map" siempre tienen como
