...
public interface ClasificadorBayesiano {
	...
	/*
	 * Dado una instancia en formato CSV, precide la clase.
	 ...
	 * usando el método 'clasifica'. Las instancias del fichero
	 * tienen como último atributo su clase.
